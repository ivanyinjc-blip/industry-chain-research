...
> 完整的 反证段 段契约。Claude/Codex 调用本段时,只需读这一节。

### 🎯 触发条件

- 前序段:chain-analysis 已产 `05_analysis.md`
- 任何"看好"结论必须经过此段反证

### 📥 输入文件

- 必填:`05_analysis.md` + 上游所有产物

### 📤 输出文件

- `06_verify.md`(反证条件 + 触发矩阵)

### 🔑 必填字段

- 反证条件:每条"看好"理由配 1-2 条反证
- 触发矩阵:可量化的证伪信号
- 月度跟踪清单
